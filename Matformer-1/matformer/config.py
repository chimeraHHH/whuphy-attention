...
class TrainingConfig(BaseSettings):
    ...
    per_bin_standardize: bool = False
    weighted_loss: bool = False
    fermi_weight_sigma: Optional[float] = None
    fermi_bin_idx: Optional[int] = None
    ...
    print(model)
    # pydantic v2 uses model_validator, v1 uses root_validator
    if PYD_V2:
